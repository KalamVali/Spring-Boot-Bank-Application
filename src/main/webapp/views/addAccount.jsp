...
<body bgcolor="skyblue">
    <center>
        <form action="/register">
            ...
            <h2 style="color: red">OPEN ACCOUNT FORM</h2>
            Account Number : <input type="text" name="account_no"><p></p>
            Name : <input type="text" name="name"><p></p>
            Password : <input type="password" name="password"><p></p>
            Amount : <input type="text" name="amount"><p></p> 
            Address : <input type="text" name="address"><p></p>
            Mobile No : <input type="text" name="mobile_no"><p></p>
